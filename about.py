...
text1 = emojize(':index_pointing_up::nerd_face: 5-й Международный нефтегазовый молодежный форум – это международная '
                'молодежная образовательная площадка для решения актуальных отраслевых задач, стоящих перед '
                'топливно-энергетическим комплексом России и стран СНГ. Традиционно уже на протяжении пяти лет подряд '
                'участники предлагают прорывные идеи для решения производственных задач отрасли.')
text2 = emojize(':index_pointing_up::nerd_face: Традиционно организаторами Форума выступают Министерство энергетики '
                ...
                'Оператор образовательной программы – Благотворительный фонд "Надежная смена"')
text3 = emojize(':index_pointing_up::nerd_face: Пятый Международный нефтегазовый молодежный форум «5th INTERNATIONAL '
                'PETROLEUM YOUTH FORUM» – Хакатон Развития ТЭК 2050 пройдет в г. Альметьевск Республики Татарстан '
                'с 10 по 16 июля 2024 года.')
text4 = emojize(':index_pointing_up::nerd_face: Целевая аудитория Форума – молодые специалисты компаний ТЭК России и '
                ...
                'нефтегазовых образовательных учреждений высшего профессионального образования. Участники Форума в '
                'течение шести дней пройдут интенсивное обучение, предусматривающее сессии, мастер-классы ведущих '
                ...
                'технологическим лидерством в нефтегазодобыче, нефтепереработке и нефтегазохимии, в том числе в '
                'вопросах, индустриальных технологий и композитных материалов, повышения устойчивости  отрасли за счет '
                'развития сферы цифровых технологий в нефтегазовом секторе.')
text5 = emojize(':index_pointing_up::nerd_face: Форум будет проходить в формате хакатона и станет не только '
                'дискуссионной площадкой для молодых профессионалов, но и «точкой сбора» инициатив молодых '
                'специалистов из разных отраслей и регионов по формированию и продвижению мировоззрения '
                'технологического лидерства ТЭК России вплоть до 2050 года. Лучшие предложения и проектные идеи '
                'международных команд получат финансовую и менторскую поддержку.')
text6 = emojize(':index_pointing_up::nerd_face: Также в рамках Форума, 12 июля 2024 года состоится традиционный '
